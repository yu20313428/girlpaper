...
class MainsControllerTest < ActionController::TestCase
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post :create, main: { description: @main.description, picture: @main.picture, title: @main.title }
    end
  ...
  test "should update main" do
    patch :update, id: @main, main: { description: @main.description, picture: @main.picture, title: @main.title }
    assert_redirected_to main_path(assigns(:main))
  end
